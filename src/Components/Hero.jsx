  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        transition={{ duration: 0.5, delay: 0.7 }}
        viewport={{ once: true }}
        className="text-4x1 sm:text-5x1 md:text-6xl xl:text-[84px] font-medium xl:leading-23.75 max-w-5xl"
      >
      ...
      >
        Creating meaningful connections and turning big idea into interactive
        digital experiences.
      </motion.p>
