  ...
  const workData = [
    {
      ...
      description:
        "We create and execute mobile app marketing strategies that drive downloads and user engagement.",
      icon: assets.work_mobile_app,
    },
    {
      title: "Dashboard Management",
      description:
        "We provide comprehensive dashboard management services to help you monitor and optimize your digital marketing performance.",
      icon: assets.work_dashboard_management,
    },
    {
      title: "Fitness App Promotion",
      description:
        "We develop and implement effective promotion strategies to help you reach your target audience and achieve your marketing goals.",
